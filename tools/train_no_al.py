...
# TODO DEBUG, why there seems to be half of the data loaded for training?
...
def main(args):
    ...
    cfg = create_X_L_file(cfg, X_L, all_anns, cycle=0)
    # load model
    start = tic()
    ...
    for epoch in range(cfg.epoch):
        ...
        if epoch == cfg.epoch - 1:
            ...
            cfg.evaluation.interval = 1  # TODO Change
